...
export class PlaceOrderBatch1760000001000 implements MigrationInterface {
  name = 'PlaceOrderBatch1760000001000';
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      BEGIN
        ...
        -- Lock every product touched by the batch in a deterministic order.
        FOR product_row IN
        ...
        LOOP
          ...
          LOOP
            ...
            IF EXISTS (
              ...
              WHERE orders.user_id = job_row.user_id
                AND orders.product_id = job_row.product_id
            ) THEN
              INSERT INTO order_results (job_id, user_id, product_id, status, order_id, processed_at, message)
          ...
          IF sold_count > 0 THEN
            UPDATE products
            SET remaining_stock = remaining_stock - sold_count,
